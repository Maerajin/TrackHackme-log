## TryHackMe:[Intro] Security Operations & Offensive Tolling Basics
...
## 실무 적용 가능성
 (1) DFIR의 중요성 : 사이버 공격 발생 시 시스템을 재부팅하는 것이 아니라 공격이 어디서 발생되었는지 탐지하고 어떤 공격인지 분석한 뒤에 공격 지점을 네트워크로 부터 격리하고 로그를 보존하는 것만이 피해 확산을 막을 수 있다.
...
## 실습 화면 기록
![실습 결과](images/Offensive_Security_Intro.png)
